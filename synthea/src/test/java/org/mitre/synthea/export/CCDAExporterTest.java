...
public class CCDAExporterTest {
  ...
  public static void setup() {
    // The Australian configuration does not include US payer files, so tests that
    // attempt to load them will fail. By disabling payers, the Generator will not
    // attempt to load US-specific files.
