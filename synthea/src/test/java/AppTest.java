...
public class AppTest {
  ...
  public static void testSetup() throws Exception {
    ...
    testStateDefault = Config.get("test_state.default", "Victoria");
    testTownDefault = Config.get("test_town.default", "Melbourne");
    testStateAlternative = Config.get("test_state.alternative", "New South Wales");
    testTownAlternative = Config.get("test_town.alternative", "Sydney");
    Generator.DEFAULT_STATE = testStateDefault;
    // The Australian configuration does not include US payer files.
    // Disable payers so the generator does not attempt to load US-specific files.
    Config.set("generate.payers.enabled", "false");
  }
